...
关于字体设置，之前一直没有认真学习过，最近查看各大官网的字体设置，开始学习，以某僵为例，

  font-family: "Open Sans","PingFang SC","Microsoft YaHei","Helvetica Neue","Hiragino Sans GB","WenQuanYi Micro Hei",Arial,sans-serif;

是不是一脸懵逼的感觉呢？那么看了下文，你就会豁然开朗，拥有醍醐灌顶之感,感谢这位博主无私的分享：
...
在不同操作系统、不同游览器里面默认显示的字体是不一样的，并且相同字体在不同操作系统里面渲染的效果也不尽相同，那么如何设置字体显示效果会比较好呢？下面我们逐步的分析一下：
